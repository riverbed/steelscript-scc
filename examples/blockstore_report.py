...
class BlockStoreStatsReportApp(SCCApp):

    def add_options(self, parser):
        super(BlockStoreStatsReportApp, self).add_options(parser)
        ...
        parser.add_option(
            '--traffic_type', dest='traffic_type', default='commit_throughput',
            help='Type of traffic to query: hit_miss, uncmtd_first_classid, '
            'uncmtd_last_classid, commit_throughput, commit_delay')

        parser.add_option('--lun_subclass_id', dest='lun_subclass_id',
                          default=None, help='Integer value')

        parser.add_option('--device', dest='device', default=None,
                          help='Device ID')

    def validate_args(self):
        super(BlockStoreStatsReportApp, self).validate_args()
    ...
    def main(self):
        with report_module.SteelFusionBlockstoreReport(self.scc) as report:
